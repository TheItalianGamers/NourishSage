const Dropdown = (props: any) => {
  ...
  return (
    <ul className=" fixed top-[72px] z-50 w-full max-h-full overflow-y-auto text-white bg-tig-dark-gray flex flex-col gap-2 p-2 scroll ">
        ...
        if (el.Nome.toLowerCase().startsWith(props.inputValue.toLowerCase())) {
          return (
            <li
              ...
              className="cursor-pointer hover:bg-zinc-700 flex flex-row gap-3"
            >
              <p>{el.Nome}</p>
            </li>
          );
